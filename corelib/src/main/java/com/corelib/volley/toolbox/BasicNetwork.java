...
import com.corelib.volley.RetryPolicy;
import com.corelib.volley.ServerError;
    ...
    public NetworkResponse performRequest(Request<?> request) throws VolleyError {
        ...
        while (true) {
            ...
            try {
                ...
                attemptRetryOnException("socket", request, new TimeoutError(new NetworkResponse(0,
                        responseContents, responseHeaders, false)));
            } catch (ConnectTimeoutException e) {
                attemptRetryOnException("connection", request, new TimeoutError(
                        new NetworkResponse(0, responseContents, responseHeaders, false)));
