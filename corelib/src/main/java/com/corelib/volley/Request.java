...
import com.corelib.volley.VolleyLog.MarkerLog;
...
public abstract class Request<T> implements Comparable<Request<T>> {
    ...
    //Sinanews V6.0添加应对dns异常，指定Host访问IP，其它情况禁用
    private String dnsRequestHost;

    public String getDnsRequestHost() {
        return dnsRequestHost;
    }
    //Sinanews V6.0添加应对dns异常，指定Host访问IP，其它情况禁用
    public void setDnsRequestHost(String host) {
        this.dnsRequestHost = host;
    }
     ...
     *
     * @deprecated Use {@link #Request(int, String, com.corelib.volley.Response.ErrorListener)}.
     */
    @Deprecated
    ...
    /**
     * 子类可以重写该方法来解析缓存内容。参考{@link com.android.volley.toolbox.ImageRequest#parseCache()}
     * 
     * @return
     *
     * @author xuegang
     * @version Created: 2014年11月6日 下午12:04:53
     */
    protected Response<T> parseCache() {
